...
public class CommandHandler {
	...
	public CommandHandler(Logger logger) {
		this.commandList = Arrays.asList(new HelpCommand(), new LogLevelCommand(), new ServerTypeCommand(), new ListCommand(), new StopCommand(), new BackupCommand(),
	...
	public void tryToExecuteCommand(String[] args) {
		...
		String cmd = args[0];
		log.info("Console command: {}", Arrays.toString(args));
